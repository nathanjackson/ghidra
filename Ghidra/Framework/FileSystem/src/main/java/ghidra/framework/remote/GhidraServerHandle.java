...
public interface GhidraServerHandle extends Remote {
	 ...
	 *   14: Added OidcAuthenticationCallback for OIDC device-code authentication
	 *       (device/token endpoints, nonce, login challenge). Server still supports
	 *       older clients back to interface version 11.
	 */
